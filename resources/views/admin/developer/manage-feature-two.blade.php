                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach($features as $feature)
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{{ route('edit.feature.two',['id' => $feature->id]) }}" class="text-success btn btn-primary">Edit</a>
                                    <a href="#" id="{{ $feature->id }}" class="text-danger delete-btn btn btn-danger" onclick="
                                            ...
                                            ">Delete</a>
                                    <form id="deleteFeatureForm{{ $feature->id }}" action="{{ route('delete.feature.two') }}" method="POST">
                                        @csrf
